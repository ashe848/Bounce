...
public interface Painter {
	...
	/**
	 * Draws and colours a rectangle. Parameters x and y specify the top left corner of the
	 * oval. Parameters width and height specify its width and height. Colour specifies colour to be filled.
	 */
